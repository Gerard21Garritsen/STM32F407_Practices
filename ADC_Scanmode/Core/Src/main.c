...
/*This is an example of how to use ADC in Scan Mode with DMA
 * Microcontroller used was STM32F407VGT6
 */
/**
  ******************************************************************************
  * @file           : main.c
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
#define ADC_CNV 3 //Number of conversions
uint16_t adc_values[ADC_CNV];
float adc_voltages[ADC_CNV];
char adc_cadena[50];
